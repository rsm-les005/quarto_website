...
sns.histplot(airbnb_filtered["number_of_reviews"], bins=50, kde=False, ax=axes[0, 0])
axes[0, 0].set_title("Number of Reviews")

sns.histplot(airbnb_filtered["price"], bins=50, kde=False, ax=axes[0, 1])
axes[0, 1].set_title("Price per Night")

sns.histplot(airbnb_filtered["review_scores_cleanliness"], bins=10, kde=False, ax=axes[1, 0])
axes[1, 0].set_title("Cleanliness Score")

sns.histplot(airbnb_filtered["review_scores_value"], bins=10, kde=False, ax=axes[1, 1])
